...
@Component({
  selector: 'app-partidas-live',
  templateUrl: './partidas-live.component.html',
  styleUrls: ['/src/assets/styles/cards.css']
})
export class PartidasLiveComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.data.getPartidasLive().subscribe((data: any)=> {
